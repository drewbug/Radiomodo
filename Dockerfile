# BUILD-USING:        docker build -t qualia/radiomodo .
# RUN-USING:          docker run -i -name radiomodo qualia/radiomodo && docker wait radiomodo && docker cp radiomodo:/root/app/bin/Radiomodo-release.apk . && docker rm radiomodo
